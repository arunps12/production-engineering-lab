...
1. Edit `practice/curriculum/07-rest-api-crud-labs/pyproject.toml`
...
1. Edit `practice/curriculum/07-rest-api-crud-labs/tests/test_crud.py`
...
1. Edit `practice/curriculum/08-postgresql-production-labs/docker-compose.yml`
...
cd practice/curriculum/07-rest-api-crud-labs
uv sync
