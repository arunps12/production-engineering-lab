"""
Section 4 — Database: Intermediate (C1-C7) + Debug (D1-D5)
Guide: docs/curriculum/04-database-fundamentals.md
"""


# Exercise 9.C.1 — Connection Pool
...
# Exercise 9.C.2 — Migration System
...
# Exercise 9.C.4 — Cache-Aside Pattern
...
# Exercise 9.C.5 — Rate Limiter with Redis
...
# Exercise 9.D.1 — Connection Pool Exhaustion
