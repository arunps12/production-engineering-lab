...
PG_DIR="$CURRICULUM/14-postgresql-production-labs"
...
ES_DIR="$CURRICULUM/15-elasticsearch-practice"
...
FUSEKI_DIR="$CURRICULUM/16-rdf-sparql-labs"
...
CRUD_DIR="$CURRICULUM/17-rest-api-crud-labs"
