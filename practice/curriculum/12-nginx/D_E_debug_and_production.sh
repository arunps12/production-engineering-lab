#!/bin/bash
# =============================================================================
# Section 12 — Nginx: Debug Lab (D1-D5) + Production (E1)
# Guide: docs/curriculum/12-nginx-reverse-proxy.md
# =============================================================================
...
# Exercise 12.D.2 — Debug: Upstream Timeout (504)
...
# --- PRODUCTION ---
# Exercise 12.E.1 — Complete Reverse Proxy Setup
