# SECTION 8 — GIT & VERSION CONTROL (DEEP DIVE)
...
### Exercise 8.C.2 — Git Bisect (Find Bug-Introducing Commit)
...
### Exercise 8.C.6 — Advanced .gitignore Patterns
...
### Exercise 8.C.7 — Rewriting History with filter-branch/filter-repo
...
### Exercise 8.D.5 — Debug: Large File Accidentally Committed
...
---
*Previous: [Section 7 — Monitoring & Observability](07-monitoring-observability.md)*
*Next: [Section 9 — Database Fundamentals](09-database-fundamentals.md)*
