# SECTION 12 — CLOUD & INFRASTRUCTURE BASICS
...
### Exercise 12.B.1 — Cloud Mental Model
...
### Exercise 12.B.2 — SSH into a Remote Server
...
### Exercise 12.B.3 — SCP and File Transfer
...
### Exercise 12.B.4 — First Terraform Configuration
...
### Exercise 12.B.5 — Terraform Variables and Outputs
...
### Exercise 12.B.6 — Object Storage Concepts
...
### Exercise 12.B.7 — Environment Parity with Docker
...
### Exercise 12.C.1 — Terraform Modules
...
### Exercise 12.C.2 — Terraform State Management
...
### Exercise 12.C.3 — Docker Registry
...
### Exercise 12.C.4 — Health Checks and Readiness
...
### Exercise 12.C.6 — Blue-Green Deployment Concept
...
### Exercise 12.D.1 — Debug: Terraform State Drift
...
### Exercise 12.D.3 — Debug: Container Registry Auth Failure
...
### Exercise 12.D.5 — Debug: Terraform Destroy Stuck
...
---
*Next: [Section 13 — Nginx & Reverse Proxy](13-nginx-reverse-proxy.md)*
