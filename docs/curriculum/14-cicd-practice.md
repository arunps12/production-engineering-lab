...
ruff check practice/curriculum/07-rest-api-crud-labs/

# Auto-fix issues
ruff check --fix practice/curriculum/07-rest-api-crud-labs/

# Format
ruff format practice/curriculum/07-rest-api-crud-labs/
```
...
---
*Previous: [Section 13 — CI/CD Automation](13-ci-cd-automation.md)*
