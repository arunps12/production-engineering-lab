# SECTION 2 — GIT & VERSION CONTROL (DEEP DIVE)
...
---
*Previous: [Section 1 — Linux Fundamentals](01-linux-fundamentals.md)*
*Next: [Section 3 — Networking & Debug Lab](03-networking-debug-lab.md)*
