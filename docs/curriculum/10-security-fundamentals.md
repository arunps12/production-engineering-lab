# SECTION 10 — SECURITY FUNDAMENTALS FOR DEVOPS
...
### Exercise 10.B.2 — .env Files with python-dotenv
...
### Exercise 10.B.6 — HTTPS with FastAPI (Development)
...
### Exercise 10.C.1 — JWT Authentication in FastAPI
...
### Exercise 10.C.2 — Role-Based Access Control (RBAC)
...
### Exercise 10.C.3 — Rate Limiting for API Protection
...
### Exercise 10.C.4 — Secrets in Docker
...
### Exercise 10.C.5 — Security Headers
...
---
*Next: [Section 11 — Cloud & Infrastructure Basics](11-cloud-infrastructure-basics.md)*
